...
def run_exp4(api_key: str, K: int = 5, model: str = "claude-sonnet-4-20250514"):
    ...
    print("\n" + "=" * 60)
    print("CONDITION A: Uniform τ=0.7")
    print("=" * 60)
    
    result_a = run_afg_experiment(
        client=client, personas=personas, stimulus=stimulus, probes=probes,
    ...
    print("\n" + "=" * 60)
    print("CONDITION B: Stratified τ∈[0.6, 1.1]")
    print("=" * 60)
    ...
    result_c = run_afg_experiment(
        client=client, personas=adv_personas, stimulus=stimulus, probes=probes,
        K=K, signal_state=signal_state, temperature_mode="stratified",
    ...
    print(f"(Threshold δ = 0.85; runs above are flagged)")
